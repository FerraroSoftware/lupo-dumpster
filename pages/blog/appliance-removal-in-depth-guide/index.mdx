...
export const title =
  "Appliance Removal: An In-Depth Guide | Lupo Dumpster Rentals";
...
<Bloglayout title={article.title} date={article.date}>

![junk removal](/applianceremoval/appliances-removal.png)
...
![junk removal](/applianceremoval/appliance-cleanup.png)
