...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "We offer same day services in Lutz, and surrounding areas. This is contingent on distance, time of request for trailer and availability. It's best to check with us to see if they offer same-day service and if it's available in your area.",
    items: [],
  },

  {
    ...
    answer:
      "Yes we do! We do take items to the Lutz recycling center and donate items to local charities.",
    items: [],
  },
  {
...
export default function junkremoval() {
  return (
    <>
      <Head>
        <title>Dumpster Rental Lutz | Trash Disposal | Call Now</title>
        <meta
          name="description"
          content="Cluttered space? Let us take care of it. Our professional and hassle-free Dumpster Rental services in Lutz, FL will leave your space clean and organized."
        />
                ...
                <div className="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
                  ...
                  <div className="relative px-6 py-16 sm:py-24 lg:px-8 lg:py-32">
                    ...
                    <p className="mx-auto mt-6 max-w-lg text-center text-xl text-gray-200 sm:max-w-3xl">
                      ...
                      with Lutz&apos;s premier Dumpster Rental service, catering
                      to all your disposal needs responsibly.
                    </p>
        ...
        <div className="mx-auto max-w-7xl py-16 px-6 sm:py-24 lg:px-8">
          <div className="text-center">
            <h1 className="text-3xl font-bold leading-tight text-red-600 sm:text-4xl lg:text-5xl">
              Lutz&apos;s Premier Dumpster Rental Service
            </h1>
              ...
              <div>
                ...
                <div className="mt-6">
                  <h2 className="text-3xl font-bold tracking-tight text-white">
                    From Home Cleanouts to Construction Debris – We Handle It
                    All in Lutz
                  </h2>
                  <p className="mt-4 text-lg text-gray-400">
                    No task is too big or small for our dumpsters. Whether
                    it&apos;s a home decluttering spree or a construction site
                    cleanup, Lutz&apos;s residents turn to us for reliable and
                    versatile waste disposal solutions.
                  </p>
                  <div className="mt-6">
                    <Link
                      href="/contact"
          ...
          <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
            <div className="mx-auto max-w-xl px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:py-32 lg:px-0">
              <div>
                ...
                <div className="mt-6">
                  <h2 className="text-3xl font-bold tracking-tight text-white">
                    Hassle-Free Dumpster Rentals Now Available in Lutz!
                  </h2>
                  <p className="mt-4 text-lg text-gray-400">
                    Our commitment is to make your rental experience seamless.
                    From easy online booking to prompt drop-off and pickup,
                    we&apos;ve revolutionized dumpster rental in Lutz to be as
                    easy as 1-2-3. Give us a call today to get started!
                  </p>
                  <div className="mt-6">
                    <Link
                      href="/contact"
        ...
        <div className="mx-auto max-w-7xl py-16 sm:py-24 px-6  lg:grid lg:grid-cols-3 lg:gap-x-12 lg:px-8 ">
          <div>
            <h2 className="text-lg font-semibold leading-8 tracking-tight text-red-600">
              Lutz Dumpster Services
            </h2>
            <p className="mt-2 text-4xl font-bold tracking-tight text-white">
              We Take Care of Your Trash
            </p>
            <p className="mt-6 text-base leading-7 text-gray-400">
              Our Lutz dumpster services are more than just waste disposal, they
              are a commitment to the community. We offer a comprehensive range
              of solutions designed to meet the diverse needs of both residents
              and businesses. Whether you&apos;re embarking on a major
              renovation, clearing out a space, or managing a commercial site,
              our reliable and efficient dumpsters are at your disposal.
            </p>
          </div>
          ...
          <div className="relative isolate overflow-hidden bg-[#14120E] px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
            ...
            <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-300">
                Efficient clutter disposal in Lutz with our dumpster
