  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Hoarding cleanup in New Port Richey, FL by Lupo Dumpster Rentals. Compassionate full-service cleanouts at flat rates. Call (727) 317-6717."
        />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
        <Seo
          title="Flat Rates | Hoarder Cleaning Service in New Port Richey, FL"
          description="Hoarding cleanup in New Port Richey, FL by Lupo Dumpster Rentals. Compassionate full-service cleanouts at flat rates. Call (727) 317-6717."
          path="/services/hoarding-cleanup-new-port-richey-fl"
        />
      </Head>
      <div className="">
          ...
          <div className="relative isolate overflow-hidden bg-[#14120E] px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
            ...
            <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
                ...
                >
                  See hoarding cleanup FAQs <span aria-hidden="true">→</span>
                </a>
              </div>
            </div>
            <div className="relative mt-16 h-80 lg:mt-8">
              <img
                ...
                src="/dump1.png"
                alt="Hoarding cleanup dumpster in New Port Richey, FL by Lupo Dumpster Rentals"
                width={1824}
                height={1080}
              />
            </div>
