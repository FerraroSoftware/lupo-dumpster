  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Dumpster Rental Services in Holiday, FL. We offer affordable and convenient dumpster rental services for any project. We are family owned. Contact us today!"
        />
              ...
              <div>
                ...
                <div className="mt-6">
                  <h2 className="text-3xl font-bold tracking-tight text-white">
                    One-Stop Shop for Dumpster Rentals in Holiday, FL
                  </h2>
            ...
            <div className="mt-12 sm:mt-16 lg:mt-0">
              <div className="-mr-48 pl-6 md:-mr-16 lg:relative lg:m-0 lg:h-full lg:px-0">
                <Image
                  ...
                  src={dump1}
                  alt="Dumpster Rental Holiday, FL"
                />
              </div>
            </div>
          </div>
          ...
          <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
            <div className="mx-auto max-w-xl px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:py-32 lg:px-0">
              <div>
                ...
                <div className="mt-6">
                  <h2 className="text-3xl font-bold tracking-tight text-white">
                    Rent a Roll-Off Dumpster for Your Holiday Remodel Project
                  </h2>
                  <p className="mt-4 text-lg text-gray-400">
                    We are the go-to choice for dumpster rentals in Holiday, FL.
                    We offer a range of dumpster sizes to fit your specific
                    needs, including 10, 20, and 30 cubic yard dumpsters. We
                    have the experience and knowledge to help you choose the
                    right size for your project. Whether cleaning out a garage,
                    home, or construction site or tackling any other type of
                    project, we have the perfect dumpster rental solution. In
                    addition to our wide selection of dumpster sizes, we also
                    offer flexible rental periods and competitive pricing. We
                    strive to give you the best value for your money and are
                    committed to finding the right solution to meet your budget
                    and timeline. If you are looking for the best dumpster
                    rental provider in Holiday, FL, near you, look at Lupo
                    Dumpster Rentals. Contact us now.
                  </p>
                  <div className="mt-6">
                    <Link
                      href="/contact"
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="sm:text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-gray-400">
              The Right Dumpster for Your Holiday Waste Removal Needs
            </p>
          </div>
          ...
          <div className="relative isolate overflow-hidden bg-[#14120E] px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
            ...
            <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-300">
                Efficient clutter disposal in Holiday with our dumpster
