      ...
      <main className="isolate">
            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
              <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
                ...
                <p className="mt-6 text-xl leading-8 text-zinc-600">
                  We are proud to have served over 1000+ customers in the Tampa
                  Bay area. Our customers love us for our reliability, pricing,
                  and efficiency.
                </p>
                <p className="mt-6 text-base leading-7 text-zinc-600">
                  We offer a wide range of services, including dumpster rentals,
                  junk removal, demolition services and much more. We are
                  committed to providing our customers with the best service
                  possible.
                </p>
              </div>
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <p className="mt-6 text-base leading-7 text-zinc-600">
              Our team is dedicated to ensuring that every project is completed
              on time and within budget. We take pride in our work and strive to
            ...
            <div className="flex flex-col-reverse justify-between gap-x-16 gap-y-8 rounded-md bg-zinc-200 p-8 sm:w-11/12 sm:max-w-xl sm:flex-row-reverse sm:items-end lg:w-full lg:max-w-none lg:flex-auto lg:flex-col lg:items-start lg:gap-y-28">
              ...
              <div className="sm:w-80 sm:shrink lg:w-auto lg:flex-none">
                ...
                <p className="mt-2 text-base leading-7 text-zinc-700">
                  60% of our rentals serve construction and renovation projects,
                  while 40% support cleanouts and other waste disposal needs.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto flex max-w-2xl flex-col items-end justify-between gap-16 lg:mx-0 lg:max-w-none lg:flex-row">
            <div className="w-full lg:max-w-lg lg:flex-auto">
              ...
              <p className="mt-6 text-xl leading-8 text-zinc-700">
                Our company is constantly growing and expanding our services to
