...
export default function Junkcost() {
  return (
          ...
          <div className="mt-6 sm:mt-0 sm:ml-12">
            <blockquote>
              <p className="text-lg font-normal leading-relaxed text-gray-900 ">
                At Lupo Dumpster Rentals, we{"'"}re proud to offer junk removal
                services in New Port Richey. Pricing starts at $75 and pricing
                will vary depending on location, and amount of junk being
                disposed. Contact us today for a free quote!
              </p>
            </blockquote>
