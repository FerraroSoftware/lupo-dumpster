        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-12 lg:gap-x-16 xl:gap-x-32">
            <div className="flex flex-col self-stretch justify-between">
              ...
              <div className="relative mt-10 overflow-hidden bg-red-600 lg:mt-0 rounded-3xl -rotate-3">
            ...
            <div className="bg-white shadow-xl rounded-2xl">
              <div className="p-6 sm:p-10">
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center w-full px-12 py-4 text-base font-medium text-white transition-all duration-200 bg-red-600 border border-transparent rounded-xl hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-700"
                  >
                    Send message
                  </button>
                  <ToastContainer
