...
import alex from "../public/alex-lupo.png";
export default function Twentyyard2() {
  return (
    <section className="py-12 bg-[#ECECEC] sm:py-16 lg:py-20">
          ...
          <div className="mt-6 sm:mt-0 sm:ml-12">
            <blockquote>
              <p className="text-lg font-normal leading-relaxed text-gray-900 ">
                At Lupo Dumpster Rentals, we{"'"}re proud to offer our 20 cubic
                yard trailer for all your large projects in New Port Richey.
                Rental includes 4 days and pricing vary depending on rental
                length, location, and materials being disposed. Contact us today
                to find out more and reserve your trailer!
              </p>
            </blockquote>
            <p className="mt-5 text-base font-bold text-gray-900 ">Alex Lupo</p>
            <p className="text-sm font-normal text-gray-600  mt-0.5">
              Founder, Lupo Dumpster Rentals
            </p>
          </div>
        </div>
      </div>
