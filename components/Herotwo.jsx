        ...
        <div className="mx-auto max-w-3xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            >
              ...
              for a reliable dumpster rental company, we've got you covered. Our
              company offers affordable prices, convenient junk removal
              services, and top-notch customer service. Don't hesitate to reach
              out to us for all your waste management needs.
            </motion.p>
            <motion.div
