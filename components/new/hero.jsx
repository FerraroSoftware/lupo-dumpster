  ...
  return (
    <section className="relative bg-black text-white min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <video autoPlay muted loop playsInline className="absolute inset-0 w-full h-full object-cover z-0">
        <source src="/dumpster-video.mp4" type="video/mp4" />
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-20 text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto">
            Lupo Dumpster Rentals and Junk Removal is a locally owned and operated business that specializes in
            providing dumpster rentals and junk removal services and more in Pasco County, Florida.
          </p>
