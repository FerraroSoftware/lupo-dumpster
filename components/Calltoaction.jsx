        ...
        <div className="max-w-xl mx-auto text-center">
          ...
          >
            <a
              href="#contact"
              title=""
              className="inline-flex items-center justify-center px-8 py-3 text-base font-bold leading-7 text-gray-900 transition-all duration-200 bg-zinc-100 border border-transparent rounded-md hover:bg-opacity-90"
              role="button"
            >
              Contact Us Now
            </a>
